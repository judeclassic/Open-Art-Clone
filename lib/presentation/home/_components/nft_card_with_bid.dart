...
class NFTViewCardWithBid extends StatefulWidget {
  final NftCardModel nftCardModel;
  const NFTViewCardWithBid({Key? key, required this.nftCardModel}) : super(key: key);

  @override
  State<NFTViewCardWithBid> createState() => _NFTViewCardWithBidState();
}

class _NFTViewCardWithBidState extends State<NFTViewCardWithBid> {
  @override
